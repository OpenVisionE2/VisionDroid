...
package org.openvision.visiondroid.intents;
...
public class IntentFactory {
	...
	private static Intent getVideoIntent(Context context, String uriString) {
		Intent intent;
		if(PreferenceManager.getDefaultSharedPreferences(context).getBoolean(VisionDroid.PREFS_KEY_INTEGRATED_PLAYER, true))
	...
	public static Intent getStreamServiceIntent(Context context, String ref, String title, @Nullable String bouquetRef, @Nullable ExtendedHashMap serviceInfo) {
		...
		Log.i(VisionDroid.LOG_TAG, "Service-Streaming URL set to '" + uriString + "'");
		...
		if(serviceInfo != null && PreferenceManager.getDefaultSharedPreferences(context).getBoolean(VisionDroid.PREFS_KEY_INTEGRATED_PLAYER, true))
	...
	public static Intent getStreamFileIntent(Context context, @NonNull String ref, String fileName, String title, @Nullable ExtendedHashMap fileInfo) {
		...
		Log.i(VisionDroid.LOG_TAG, "File-Streaming URL set to '" + uriString + "'");
		Intent intent = getVideoIntent(context, uriString);
		intent.putExtra("title", title);
		if(fileInfo != null && PreferenceManager.getDefaultSharedPreferences(context).getBoolean(VisionDroid.PREFS_KEY_INTEGRATED_PLAYER, true))
