...
import org.openvision.visiondroid.tv.activities.PreferenceActivity;
import org.openvision.visiondroid.tv.fragment.abs.BaseHttpBrowseFragment;
import org.openvision.visiondroid.tv.presenter.CardPresenter;
...
public class RootBrowseFragment extends BaseHttpBrowseFragment implements ProfileChangedListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setBrandColor(ContextCompat.getColor(getContext(), R.color.primary_visiondroid));
		setBadgeDrawable(ContextCompat.getDrawable(getContext(), R.drawable.visiondroid_header));
		addSettingsRow();
		mRequireReload = true;
	}
	...
	@Override
	public void onStop() {
		VisionDroid.setCurrentProfileChangedListener(null);
		super.onStop();
	}
