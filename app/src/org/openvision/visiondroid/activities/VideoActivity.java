...
import org.openvision.visiondroid.fragment.VideoOverlayFragment;
...
public class VideoActivity extends AppCompatActivity implements IVLCVout.OnNewVideoLayoutListener, IVLCVout.Callback, ActionDialog.DialogActionListener, MediaPlayer.EventListener {
	...
	public void handleIntent(@NonNull Intent intent) {
		...
		if ( Intent.ACTION_VIEW.equals(intent.getAction()) ) {
			int accel = Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(this).getString(VisionDroid.PREFS_KEY_HWACCEL, Integer.toString(VLCPlayer.MEDIA_HWACCEL_ENABLED)));
