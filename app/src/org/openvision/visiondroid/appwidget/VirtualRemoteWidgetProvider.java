...
import org.openvision.visiondroid.fragment.VirtualRemoteFragment;
...
public class VirtualRemoteWidgetProvider extends AppWidgetProvider {
    ...
    public static void updateWidget(@NonNull Context context, @NonNull AppWidgetManager appWidgetManager,
        ...
        boolean mPlayButtonAsPlayPause = PreferenceManager.getDefaultSharedPreferences(context).getBoolean(VisionDroid.PREFS_KEY_PLAY_BUTTON_AS_PLAY_PAUSE, false);
