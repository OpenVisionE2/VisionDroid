...
import org.openvision.visiondroid.adapter.recyclerview.TimerAdapter;
...
import org.openvision.visiondroid.helpers.enigma2.requesthandler.TimerChangeRequestHandler;
import org.openvision.visiondroid.helpers.enigma2.requesthandler.TimerCleanupRequestHandler;
import org.openvision.visiondroid.helpers.enigma2.requesthandler.TimerDeleteRequestHandler;
import org.openvision.visiondroid.helpers.enigma2.requesthandler.TimerListRequestHandler;
import org.openvision.visiondroid.loader.AsyncListLoader;
import org.openvision.visiondroid.loader.LoaderResult;
import org.openvision.visiondroid.widget.helper.ItemSelectionSupport;
		...
		if (requestCode == Statics.REQUEST_EDIT_TIMER) {
			if (resultCode == Activity.RESULT_OK) {
				if (getAppCompatActivity() != null) // we're somewhere active!
					// reload();
					Log.w(VisionDroid.LOG_TAG, "TIMER SAVED!");
			}
		}
	}
