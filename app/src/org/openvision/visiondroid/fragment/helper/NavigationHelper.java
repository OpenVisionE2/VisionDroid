...
import org.openvision.visiondroid.activities.SimpleNoTitleFragmentActivity;
import org.openvision.visiondroid.activities.SimpleToolbarFragmentActivity;
import org.openvision.visiondroid.asynctask.SetPowerStateTask;
import org.openvision.visiondroid.asynctask.SimpleResultTask;
import org.openvision.visiondroid.asynctask.SleepTimerTask;
import org.openvision.visiondroid.fragment.BackupFragment;
import org.openvision.visiondroid.fragment.CurrentServiceFragment;
...
import org.openvision.visiondroid.helpers.enigma2.Message;
...
import org.openvision.visiondroid.helpers.enigma2.requesthandler.MessageRequestHandler;
    ...
    protected boolean onNavigationItemClick(int itemId) {
        ...
        switch (itemId) {
            ...
            case Statics.ITEM_CHECK_CONN:
                getMainActivity().onProfileChanged(VisionDroid.getCurrentProfile());
                break;
