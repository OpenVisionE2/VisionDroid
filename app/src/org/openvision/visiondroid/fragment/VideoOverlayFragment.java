...
import org.openvision.visiondroid.activities.VideoActivity;
import org.openvision.visiondroid.adapter.recyclerview.ServiceAdapter;
...
import org.openvision.visiondroid.helpers.enigma2.requesthandler.EpgNowNextListRequestHandler;
...
import org.openvision.visiondroid.tv.fragment.EpgDetailDialog;
import org.openvision.visiondroid.tv.fragment.MovieDetailDialog;
import org.openvision.visiondroid.video.VLCPlayer;
import org.openvision.visiondroid.view.OnRepeatListener;
import org.openvision.visiondroid.widget.helper.ItemClickSupport;
import org.openvision.visiondroid.widget.helper.SpacesItemDecoration;
...
public class VideoOverlayFragment extends Fragment implements MediaPlayer.EventListener,
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		if (mServicesView != null) {
			if (VisionDroid.isTV(getContext())) {
		...
		mGestureDector = new GestureDetectorCompat(getActivity(), new GestureDetector.SimpleOnGestureListener() {
			...
			public boolean onScroll(@NonNull MotionEvent e1, @NonNull MotionEvent e2, float distanceX, float distanceY) {
				boolean isGesturesEnabled = PreferenceManager.getDefaultSharedPreferences(getActivity()).getBoolean(VisionDroid.PREFS_KEY_VIDEO_ENABLE_GESTURES, true);
