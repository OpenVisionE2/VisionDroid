...
import org.openvision.visiondroid.helpers.enigma2.Remote;
...
public class VirtualRemoteFragment extends BaseHttpFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mQuickZap = getArguments().getBoolean(VisionDroid.PREFS_KEY_QUICKZAP, prefs.getBoolean(VisionDroid.PREFS_KEY_QUICKZAP, false));
        mPlayButtonAsPlayPause = getArguments().getBoolean(VisionDroid.PREFS_KEY_PLAY_BUTTON_AS_PLAY_PAUSE, prefs.getBoolean(VisionDroid.PREFS_KEY_PLAY_BUTTON_AS_PLAY_PAUSE, false));
        mSimpleRemote = VisionDroid.getCurrentProfile().isSimpleRemote();
