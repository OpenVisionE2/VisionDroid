 ...
 * @author sre
 */
public class VisionDroid extends Application {
	@Nullable
	private static volatile VisionDroid instance;
	...
	public static final String ACTION_CREATE = "visiondroid.intent.action.NEW";
	public static final String LOG_TAG = "VisionDroid";
	...
	public static Context getAppContext() {
		if (instance != null) return instance;
			...
			try {
				instance = (VisionDroid) Class.forName("android.app.ActivityThread").getDeclaredMethod("currentApplication").invoke(null);
	...
	public static String getVersionString() {
		String buildDate = java.time.LocalDate.now();
/*
...
*/
	...
	public void onCreate() {
		super.onCreate();
		boolean dynamicColors = PreferenceManager.getDefaultSharedPreferences(this).getBoolean(VisionDroid.PREFS_KEY_DYNAMIC_THEME_COLORS, false);
		if (dynamicColors)
	...
	private void handleProfileSwitch(@NonNull Context context) {
		if (PreferenceManager.getDefaultSharedPreferences(this).getBoolean(
				VisionDroid.PREFS_KEY_AUTO_SWITCH_PROFILE_WIFI_BASED, false)) {
	...
	private void initChannels() {
		...
		NotificationChannel channel = new NotificationChannel("visiondroid_picon_sync",
				getString(R.string.picons),
				NotificationManager.IMPORTANCE_LOW);
		channel.setDescription(getString(R.string.sync_picons));
		notificationManager.createNotificationChannel(channel);

		channel = new NotificationChannel("visiondroid_epg_sync",
	...
	public static boolean setCurrentProfile(Context context, int id, boolean forceEvent) {
		...
		if (sProfile != null) {
			...
			Log.w(VisionDroid.LOG_TAG, "no profile with given id [" + id + "] found");
		}
		return false;
	}
